...
const RestaurantCard = (props) => {
	...
	return (
		<div
			data-testid="resCard"
			className=" flex flex-col justify-center items-center w-[250px] h-96 p-2 bg-gray-50 rounded-lg my-4 hover:bg-gray-200 shadow-gray-200 shadow-lg transition-all hover:scale-90 duration-300"
		>
			<img
